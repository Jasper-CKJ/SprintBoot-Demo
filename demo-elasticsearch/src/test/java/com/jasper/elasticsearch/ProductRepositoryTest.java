...
import com.jasper.elasticsearch.bo.ProductConditionBO;
...
class ProductRepositoryTest {
    ...
    public void test() {
        ...
        NativeSearchQueryBuilder nativeSearchQueryBuilder = new NativeSearchQueryBuilder()
                .withIndices("product");
        // 筛选
        nativeSearchQueryBuilder.withQuery(QueryBuilders.multiMatchQuery("name", "name", "sellPoint", "categoryName"));
        // 聚合
